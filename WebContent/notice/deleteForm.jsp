...
<body>
	<div class="location ">
		<div class="location_text_position">
			<a href="/main/main.do" class="m_home_area"><span
				class="location_home">HOME</span></a> <a href="/customer/notice/list.do"
				class="m_1depth"><span class="location_gt">고객센터</span></a> <span
				class="location_gt current">고객의 소리</span>
	...
	<div id="main">
				...
				<div class="collapse navbar-collapse" id="menu-content">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu">
								<a href="../property_listing.html" class="dropdown-item">List
									...
									View</a> <a href="../property_listing_map.html"
									class="dropdown-item">Map View</a> <a
									href="../property_single.html" class="dropdown-item">Single
						...
						<li class="nav-item dropdown"><a
							...
							data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								Agents </a>
							<div class="dropdown-menu">
								<a href="../agent_list.html" class="dropdown-item">Agent
									List</a> <a href="agent.html" class="dropdown-item">Agent
									Profile</a>
							</div></li>
											...
											<div class="row">
												...
												<div class="col-md-6 col-lg-3">
													<ul class="list-unstyled">
														...
														<li><a href="../property_listing_map.html">Map
																View</a></li>
														<li class="title">Single Property</li>
														<li><a href="../property_single.html">Single View
																1</a></li>
														<li><a href="../property_single2.html">Single
																View 2</a></li>
														<li><a href="../property_single3.html">Single
																View 3</a></li>
													</ul>
												</div>
												<div class="col-md-6 col-lg-3">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown user-account"><a
							...
							<div class="dropdown-menu">
								<a href="../my_profile.html" class="dropdown-item">My
									Profile</a> <a href="../my_password.html" class="dropdown-item">Change
									Password</a> <a href="../my_notifications.html"
									class="dropdown-item">Notifications</a> <a
									href="../my_membership.html" class="dropdown-item">Membership</a>
		...
		<div class="inquiry_data_table">
			<form method="POST" name="delForm"
				action="/SemiProject/notice/deletePro.do?pageNum=${pageNum}"
				onsubmit="return deleteSave()">
				<h4 class="inquiry_title">
					<span style="visibility: hidden; position: absolute">공지 삭제</span>
				</h4>
						...
						<tbody>
							...
							<tr height="30">
								<td align=center>비밀번호 : <input type="password"
									name="board_pw" size="8" maxlength="12"> <input
									type="hidden" name="b_no" value="${b_no}"></td>
							</tr>
				...
				<center>
					<input type="submit" value="삭제" class="btn btn-lg btn-primary">
					<input type="reset" value="초기화" class="btn btn-lg btn-primary">
				</center>
			</form>
