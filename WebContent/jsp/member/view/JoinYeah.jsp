    ...
    <form method="post" action="/SemiProject/test.do" name="userInfo" onsubmit="return checkValue()">
          ...
          <br>
            ...
            <div class="form-group">
              ...
              <input type="password"  maxlength="50" class="form-control" id="InputPassword2" placeholder="비밀번호 확인">
          ...
          <!-- 인증번호 전송 기능은 별도 사이트에서 구입필요
            ...
            <div> <input type="checkbox"  value="동의">우편으로 BABSAZO 소식지를 받겠습니다</div>
            ...
            <div class="form-group">
             ...
             <input type="checkbox" value="동의">이메일 수신에 동의합니다</div>
            ...
            <!-- 
              ...
              <td id="title"></td>
              <input type="text" name="fvrt_str_1" class="form-control" id="username" placeholder="SNS ID 혹은 블로그 주소를 입력해 주세요">
           ...
           <div> <input type="checkbox" name="chk_info" value="한식">한식
              ...
              <input type="text" name="fvrt_str_2" class="form-control" id="username" placeholder="기타">
            </div>
             </div>
